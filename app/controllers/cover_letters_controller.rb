class CoverLettersController < ApplicationController
  def create
    ...
    GenerateCoverLetterJob.perform_later(@cover_letter.id)
  ...
  def generate_cover_letter(offer, user, details)
    ...
    prompt = <<~PROMPT
            ...
            - si le candidat manque d'expérience, mets en avant sa motivation, sa capacité d'apprentissage, sa logique de progression et les éléments pertinents de son parcours
